    ...
    for testset in test_campaign:
        for t in testset:
            ...
            try:
                ...
                t.output += "".join(traceback.format_exception(sys.exc_type,
...
""" % test_campaign
    ...
    if local:
        External_Files.UTscapy_js.write(
            os.path.dirname(test_campaign.output_file.name))
        External_Files.UTscapy_css.write(
            os.path.dirname(test_campaign.output_file.name))
