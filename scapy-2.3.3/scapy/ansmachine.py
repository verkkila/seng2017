...
class ReferenceAM(type):
    ...
    def __new__(cls, name, bases, dct):
        ...
        if o.function_name:
            globals()[o.function_name] = lambda o=o, * \
                args, **kargs: o(*args, **kargs)()
        return o
...
class AnsweringMachine(object):
    ...
    sniff_options_list = ["store", "iface", "count",
                          "promisc", "filter", "type", "prn", "stop_filter"]
    ...
    def run(self, *args, **kargs):
        log_interactive.warning(
            "run() method deprecated. The intance is now callable")
        self(*args, **kargs)
